"use strict";
var KTModalCitiesEdit = function () {
    ...
    var save = () => {
        return $.ajax({
            url: "/Cities/Update/",
            type: "POST",
            data: $('#kt_modal_edit_cities_form').serialize()
        });
    };
    ...
    return {
        init: function () {
            table = $("#kt_cities_table").DataTable(),
                i = new bootstrap.Modal(document.querySelector("#kt_modal_edit_cities")),
                r = document.querySelector("#kt_modal_edit_cities_form"),
                t = r.querySelector("#kt_modal_edit_cities_submit"),
                e = r.querySelector("#kt_modal_edit_cities_cancel"),
                o = r.querySelector("#kt_modal_edit_cities_close"),
                ...
                // #kt_modal_edit_cities_submit button tıklandı
                ...
                // #kt_modal_edit_cities_cancel button tıklandı
                ...
                // #kt_modal_edit_cities_close button tıklandı
...
KTUtil.onDOMContentLoaded((function () { KTModalCitiesEdit.init() }));