"use strict";
var KTJoinTenderUpsert = function () {
    var f, v, s, t;


    return {
        init: function () {
            f = document.querySelector("#add_join_tender_form"),
                s = f.querySelector("#add_join_tender_submit"),
                ...
                // #add_join_tender_submit button tıklandı
...
KTUtil.onDOMContentLoaded((function () { KTJoinTenderUpsert.init() }));
