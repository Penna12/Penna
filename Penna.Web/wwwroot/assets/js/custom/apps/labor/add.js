...
var KTModalLaborsAdd = function () {
    ...
    var save = () => {
        return $.ajax({
            url: "/Labor/Create/",
            type: "POST",
            data: $('#kt_modal_add_labors_form').serialize()
        });
    };
    ...
    return {
        init: function () {
            table = $("#kt_labors_table").DataTable(),
                i = new bootstrap.Modal(document.querySelector("#kt_modal_add_labors")),
                r = document.querySelector("#kt_modal_add_labors_form"),
                t = r.querySelector("#kt_modal_add_labors_submit"),
                e = r.querySelector("#kt_modal_add_labors_cancel"),
                o = r.querySelector("#kt_modal_add_labors_close"),
                ...
                // #kt_modal_add_labors_submit button tıklandı
                ...
                // #kt_modal_add_labors_cancel button tıklandı
                ...
                // #kt_modal_add_labors_close button tıklandı
...
KTUtil.onDOMContentLoaded((function () { KTModalLaborsAdd.init() }));