"use strict";
var KTModalLaborsEdit = function () {
    ...
    var save = () => {
        return $.ajax({
            url: "/Labor/Update/",
            type: "POST",
            data: $('#kt_modal_edit_labors_form').serialize()
        });
    };

    return {
        init: function () {
            table = $("#kt_labors_table").DataTable(),
                i = new bootstrap.Modal(document.querySelector("#kt_modal_edit_labors")),
                r = document.querySelector("#kt_modal_edit_labors_form"),
                t = r.querySelector("#kt_modal_edit_labors_submit"),
                e = r.querySelector("#kt_modal_edit_labors_cancel"),
                o = r.querySelector("#kt_modal_edit_labors_close"),
                n = FormValidation.formValidation(r, {
                    fields: {
                        Name: { validators: { notEmpty: { message: "İşçilik adı gereklidir" } } },
                    },
                    fields: {
                        Info: { validators: { notEmpty: { message: "İşçilik özelliği gereklidir" } } },
                    },
                    plugins: {
                ...
                // #kt_modal_edit_labors_submit button tıklandı
                                                ...
                                                save().done((function (res) {
                                                    if (res.success) {
                                                        Swal.fire({ text: "Form basariyla kaydedildi!", icon: "success", buttonsStyling: !1, confirmButtonText: "Tamam", customClass: { confirmButton: "btn btn-primary" } })
                                                            .then((function (e1) { e1.isConfirmed && (i.hide(), t.disabled = !1, table.ajax.reload()) }))
                                                    } else {
                ...
                // #kt_modal_edit_labors_cancel button tıklandı
                ...
                // #kt_modal_edit_labors_close button tıklandı
...
KTUtil.onDOMContentLoaded((function () { KTModalLaborsEdit.init() }));