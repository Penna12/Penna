...
var KTModalUnitsEdit = function () {
    ...
    var save = () => {
        return $.ajax({
            url: "/Unit/Update/",
            type: "POST",
            data: $('#kt_modal_edit_units_form').serialize()
        });
    };
    ...
    return {
        init: function () {
            table = $("#kt_units_table").DataTable(),
                i = new bootstrap.Modal(document.querySelector("#kt_modal_edit_units")),
                r = document.querySelector("#kt_modal_edit_units_form"),
                t = r.querySelector("#kt_modal_edit_units_submit"),
                e = r.querySelector("#kt_modal_edit_units_cancel"),
                o = r.querySelector("#kt_modal_edit_units_close"),
                ...
                // #kt_modal_edit_units_submit button tıklandı
                ...
                // #kt_modal_edit_units_cancel button tıklandı
                ...
                // #kt_modal_edit_units_close button tıklandı
...
KTUtil.onDOMContentLoaded((function () { KTModalUnitsEdit.init() }));