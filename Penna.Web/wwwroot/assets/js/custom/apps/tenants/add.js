"use strict";
var KTModalTenantsAdd = function () {
    var t, e, o, n, r, i;
    ...
    var save = () => {
        return $.ajax({
            url: "/Tenants/Create/",
            type: "POST",
            data: $('#kt_modal_add_tenants_form').serialize()
        });
    };
    ...
    return {
        init: function () {
            ...
            i = new bootstrap.Modal(document.querySelector("#kt_modal_add_tenants")),
            r = document.querySelector("#kt_modal_add_tenants_form"),
            t = r.querySelector("#kt_modal_add_tenants_submit"),
            e = r.querySelector("#kt_modal_add_tenants_cancel"),
            o = r.querySelector("#kt_modal_add_tenants_close"),
            ...
            // #kt_modal_add_tenants_form [name=CountryId]  değiştirildi
...
KTUtil.onDOMContentLoaded((function () { KTModalTenantsAdd.init() }));