...
async function loadDataTable() {
    dataTable = $("#kt_pending_offer_table").DataTable({
        "ajax": {
            "url": "/Purchase/GetPendingOfferList",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            ...
            },
            {
                "data": "id",
                "render": function (data) {
                    return `<a href="/Purchase/OfferStatus/${data}" class="btn btn-icon btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="left" title="Teklif Durumu"><i class="fas fa-info"></i></a>`;
                }, "width": "7%"
            }
        ],
        language: {
...
$(document).ready(async function () {
    ...
    dataTable = $("#kt_pending_offer_table").DataTable({ "pageLength": 10, info: false, language: { sLengthMenu: "Sayfada _MENU_ kayıt göster", } }); // info:false, page:false, "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]]
    ...
    // sayfalama triggeri
    document.querySelector('[name="kt_datatable_pending_offer_length"]').addEventListener("change", (function (e) {
