"use strict";
var KTOfferPurchaseAdd = function () {
    ...
    var save = () => {
        return $.ajax({
            ...
            type: "POST",
            data: $('#add_offer_purchase_form').serialize() + sm
        });
    };
    ...
    return {
        init: function () {
            (r = document.querySelector("#add_offer_purchase_form"),
                t = r.querySelector("#add_offer_purchase_submit"),
...
KTUtil.onDOMContentLoaded((function () { KTOfferPurchaseAdd.init() }));