...
var KTModalTownsAdd = function () {
    ...
    var save = () => {
        return $.ajax({
            url: "/Towns/Create/",
            type: "POST",
            data: $('#kt_modal_add_towns_form').serialize()
        });
    };
    ...
    return {
        init: function () {
            table = $("#kt_towns_table").DataTable(),
                i = new bootstrap.Modal(document.querySelector("#kt_modal_add_towns")),
                r = document.querySelector("#kt_modal_add_towns_form"),
                t = r.querySelector("#kt_modal_add_towns_submit"),
                e = r.querySelector("#kt_modal_add_towns_cancel"),
                o = r.querySelector("#kt_modal_add_towns_close"),
            n = FormValidation.formValidation(r, {
                fields: {
                    Name: { validators: { notEmpty: { message: "İlçe adı gereklidir" } } },
            ...
            // #kt_modal_add_towns_submit button tıklandı
            ...
            // #kt_modal_add_towns_cancel button tıklandı
            ...
            // #kt_modal_add_towns_close button tıklandı
...
KTUtil.onDOMContentLoaded((function () { KTModalTownsAdd.init() }));