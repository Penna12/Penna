"use strict";
var KTModalCountriesEdit = function () {
    ...
    var save = () => {
        return $.ajax({
            ...
            type: "POST",
            data: $('#kt_modal_edit_countries_form').serialize()
        });
    };
    ...
    return {
        init: function () {
            table = $("#kt_countries_table").DataTable(),
                i = new bootstrap.Modal(document.querySelector("#kt_modal_edit_countries")),
                r = document.querySelector("#kt_modal_edit_countries_form"),
                t = r.querySelector("#kt_modal_edit_countries_submit"),
                e = r.querySelector("#kt_modal_edit_countries_cancel"),
                o = r.querySelector("#kt_modal_edit_countries_close"),
                    ...
                    fields: {
                        ...
                        DialCode: {
                            validators: {
                                ...
                                stringLength: { min: 1, max: 5, message: "min 1, max 5 karaktar girmelisiniz" },
                                regexp: {
                                    regexp: /^[0-9_]+$/,
                ...
                // #kt_modal_edit_countries_submit button tıklandı
                ...
                // #kt_modal_edit_countries_cancel button tıklandı
                ...
                // #kt_modal_edit_countries_close button tıklandı
...
KTUtil.onDOMContentLoaded((function () { KTModalCountriesEdit.init() }));