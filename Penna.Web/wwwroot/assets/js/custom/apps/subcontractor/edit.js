"use strict";
var KTModalSubcontractorEdit = function () {
    ...
    var save = () => {
        return $.ajax({
            ...
            type: "POST",
            data: $('#kt_modal_edit_subcontractors_form').serialize()
        });
    };
    ...
    return {
        init: function () {
            table = $("#kt_subcontractors_table").DataTable(),
                i = new bootstrap.Modal(document.querySelector("#kt_modal_edit_subcontractors")),
                r = document.querySelector("#kt_modal_edit_subcontractors_form"),
                t = r.querySelector("#kt_modal_edit_subcontractors_submit"),
                e = r.querySelector("#kt_modal_edit_subcontractors_cancel"),
                o = r.querySelector("#kt_modal_edit_subcontractors_close"),
                ...
                // #kt_modal_edit_subcontractors_submit button tıklandı
                ...
                // #kt_modal_edit_subcontractors_cancel button tıklandı
                ...
                // #kt_modal_edit_subcontractors_close button tıklandı
...
KTUtil.onDOMContentLoaded((function () { KTModalSubcontractorEdit.init() }));