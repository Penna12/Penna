...
namespace Penna.Data.Migrations
{
    ...
    [Migration("20211108094320_AddRemainingQuantityForPurchaseRequest")]
    partial class AddRemainingQuantityForPurchaseRequest
    {
            ...
            modelBuilder.Entity("Penna.Entities.Models.Purchase", b =>
                {
                    ...
                    b.Property<int>("SupplierCurrentAccoutId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SupplierCurrentAccoutId");
            ...
            modelBuilder.Entity("Penna.Entities.Models.Purchase", b =>
                {
                    ...
                    b.HasOne("Penna.Entities.Models.CurrentAccount", "CurrentAccount")
                        .WithMany("Purchases")
                        .HasForeignKey("SupplierCurrentAccoutId")
                        .HasConstraintName("FK_Purchases_CurrentAccount_SupplierCurrentAccoutId")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Penna.Entities.Models.PurchaseTender", b =>
                {
                    ...
                    b.HasOne("Penna.Entities.Models.CurrentAccount", "CurrentAccount")
                        .WithMany("PurchaseTenders")
                        .HasForeignKey("SupplierCurrentAccoutId")
                        .HasConstraintName("FK_PurchaseTenders_CurrentAccount_SupplierCurrentAccoutId")
                        .IsRequired();
                });
