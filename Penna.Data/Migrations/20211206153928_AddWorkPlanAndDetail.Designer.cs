...
namespace Penna.Data.Migrations
{
    ...
    [Migration("20211206153928_AddWorkPlanAndDetail")]
    partial class AddWorkPlanAndDetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Penna.Entities.Models.BlockSubcontractorBusinessGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("BlockSubcontractorId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BlockSubcontractorId");

                    b.ToTable("BlockSubcontractorBusinessGroups");
                });
            ...
            modelBuilder.Entity("Penna.Entities.Models.ConcreteCasting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ConcreteCasting");
                });

            modelBuilder.Entity("Penna.Entities.Models.ConcreteRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Penna.Entities.Models.CurrentAccount", b =>
                {
                    ...
                    b.HasIndex("Email")
                        .IsUnique()
                        .HasName("UXC_CurrentAccounts_Email");
            ...
            modelBuilder.Entity("Penna.Entities.Models.CurrentAccountDetail", b =>
                {
                    ...
                    b.Property<byte?>("ProjectInstallmentNo")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Penna.Entities.Models.Fixture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Penna.Entities.Models.FixtureEmbezzled", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("EmbezzledDate")
                        .HasColumnType("datetime");
            ...
            modelBuilder.Entity("Penna.Entities.Models.ProductInOut", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Penna.Entities.Models.Project", b =>
                {
                    ...
                    b.Property<float>("DownPaymentRate")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Penna.Entities.Models.Purchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime?>("FinalBidDateTime")
                        .HasColumnType("datetime");
                    ...
                    b.Property<int>("RequestedBlockId")
                        .HasColumnType("int");

                    b.Property<DateTime>("RequestedDeliveryDate")
                        .HasColumnType("datetime");

                    b.Property<string>("RequestedPlace")
                        .HasColumnType("nvarchar(100)")
                        .HasMaxLength(100);
            ...
            modelBuilder.Entity("Penna.Entities.Models.PurchaseRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Penna.Entities.Models.PurchaseTender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Penna.Entities.Models.WorkPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<byte>("BusinessGroup")
                        .HasColumnType("tinyint");

                    b.Property<int>("ContractorCurrentAccountId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ContractorCurrentAccountId");
            ...
            modelBuilder.Entity("Penna.Entities.Models.WorkPlanDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("AssignedWorkAmount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DoneWorkAmount")
                        .HasColumnType("int");

                    b.Property<int?>("ParentWorkPlanDetailId")
                        .HasColumnType("int");

                    b.Property<DateTime>("PlanDate")
                        .HasColumnType("datetime");

                    b.Property<int>("RefuseWorkAmount")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParentWorkPlanDetailId")
                        .IsUnique()
                        .HasFilter("[ParentWorkPlanDetailId] IS NOT NULL");
            ...
            modelBuilder.Entity("Penna.Entities.Models.BlockSubcontractorBusinessGroup", b =>
                {
                    b.HasOne("Penna.Entities.Models.BlockSubcontractor", "BlockSubcontractor")
                        .WithMany("BlockSubcontractorBusinessGroups")
                        .HasForeignKey("BlockSubcontractorId")
            ...
            modelBuilder.Entity("Penna.Entities.Models.ConcreteCasting", b =>
                {
                    b.HasOne("Penna.Entities.Models.ConcreteRequest", "ConcreteRequest")
                        .WithMany("ConcreteCastings")
            ...
            modelBuilder.Entity("Penna.Entities.Models.ConcreteRequest", b =>
                {
                    ...
                    b.HasOne("Penna.Entities.Models.Product", "Product")
                        .WithMany("ConcreteRequests")
            ...
            modelBuilder.Entity("Penna.Entities.Models.FixtureEmbezzled", b =>
                {
                    b.HasOne("Penna.Entities.Models.AppUser", "AppUser")
                        .WithMany("FixtureEmbezzleds")
                        .HasForeignKey("AppUserId")
                        .HasConstraintName("FK_FixtureEmbezzleds_AppUser_AppUserId")
                        .IsRequired();

                    b.HasOne("Penna.Entities.Models.Fixture", "Fixture")
                        .WithMany("FixtureEmbezzleds")
            ...
            modelBuilder.Entity("Penna.Entities.Models.Purchase", b =>
                {
                    ...
                    b.HasOne("Penna.Entities.Models.PurchaseRequest", "PurchaseRequest")
                        .WithMany("Purchases")
                    ...
                    b.HasOne("Penna.Entities.Models.Block", "Block")
                        .WithMany("Purchases")
                        .HasForeignKey("RequestedBlockId")
            ...
            modelBuilder.Entity("Penna.Entities.Models.PurchaseTender", b =>
                {
                    b.HasOne("Penna.Entities.Models.Purchase", "Purchase")
                        .WithMany("PurchaseTenders")
            ...
            modelBuilder.Entity("Penna.Entities.Models.WorkPlan", b =>
                {
                    b.HasOne("Penna.Entities.Models.CurrentAccount", "CurrentAccount")
                        .WithMany("WorkPlans")
                        .HasForeignKey("ContractorCurrentAccountId")
            ...
            modelBuilder.Entity("Penna.Entities.Models.WorkPlanDetail", b =>
                {
                    b.HasOne("Penna.Entities.Models.WorkPlanDetail", null)
                        .WithOne("ParentWorkPlanDetail")
                        .HasForeignKey("Penna.Entities.Models.WorkPlanDetail", "ParentWorkPlanDetailId");
                    ...
                    b.HasOne("Penna.Entities.Models.WorkPlan", "WorkPlan")
                        .WithMany("WorkPlanDetails")
