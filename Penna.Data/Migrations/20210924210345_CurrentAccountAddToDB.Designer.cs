...
namespace Penna.Data.Migrations
{
    ...
    [Migration("20210924210345_CurrentAccountAddToDB")]
    partial class CurrentAccountAddToDB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Penna.Entities.Models.Bank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Penna.Entities.Models.Bank", b =>
                {
                    b.HasOne("Penna.Entities.Models.Country", "Country")
                        ...
                        .HasConstraintName("FK_Banks_Countries_CountryId")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Penna.Entities.Models.CurrentAccount", b =>
                {
                    b.HasOne("Penna.Entities.Models.Bank", "Bank")
                        .WithMany("CurrentAccounts")
                        .HasForeignKey("BankId")
                        .HasConstraintName("FK_CurrentAccounts_Banks_BankId");

                    b.HasOne("Penna.Entities.Models.City", "City")
                        .WithMany("CurrentAccounts")
                        .HasForeignKey("CityId")
                        .HasConstraintName("FK_CurrentAccounts_Cities_CityId")
                        .IsRequired();

                    b.HasOne("Penna.Entities.Models.Country", "Country")
                        .WithMany("CurrentAccounts")
                        .HasForeignKey("CountryId")
                        .HasConstraintName("FK_CurrentAccounts_Countries_CountryId")
                        .IsRequired();

                    b.HasOne("Penna.Entities.Models.Tenant", "Tenant")
                        .WithMany("CurrentAccounts")
                        .HasForeignKey("TenantId")
                        .HasConstraintName("FK_CurrentAccounts_Tenants_TenantId")
                        .IsRequired();

                    b.HasOne("Penna.Entities.Models.Town", "Town")
                        .WithMany("CurrentAccounts")
                        .HasForeignKey("TownId")
                        .HasConstraintName("FK_CurrentAccounts_Towns_TownId")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Penna.Entities.Models.SubProject", b =>
                {
                    b.HasOne("Penna.Entities.Models.Project", "Project")
                        .WithOne("SubProject")
                        .HasForeignKey("Penna.Entities.Models.SubProject", "ProjectId")
                        .HasConstraintName("FK_SubProjects_Projects_ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Penna.Entities.Models.Subcontractor", b =>
                {
                    b.HasOne("Penna.Entities.Models.Bank", "Bank")
                        ...
                        .HasForeignKey("BankId")
                        .HasConstraintName("FK_Subcontractors_Banks_BankId");

                    b.HasOne("Penna.Entities.Models.City", "City")
                        .WithMany("Subcontractors")
                        .HasForeignKey("CityId")
                        .HasConstraintName("FK_Subcontractors_Cities_CityId")
                        .IsRequired();

                    b.HasOne("Penna.Entities.Models.Country", "Country")
                        .WithMany("Subcontractors")
                        .HasForeignKey("CountryId")
                        .HasConstraintName("FK_Subcontractors_Countries_CountryId")
                        .IsRequired();

                    b.HasOne("Penna.Entities.Models.Tenant", "Tenant")
                        .WithMany("Subcontractors")
                        .HasForeignKey("TenantId")
                        .HasConstraintName("FK_Subcontractors_Tenants_TenantId")
                        .IsRequired();

                    b.HasOne("Penna.Entities.Models.Town", "Town")
                        .WithMany("Subcontractors")
                        .HasForeignKey("TownId")
                        .HasConstraintName("FK_Subcontractors_Towns_TownId")
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Penna.Entities.Models.Vendor", b =>
                {
                    b.HasOne("Penna.Entities.Models.Bank", "Bank")
                        .WithMany("Vendors")
                        .HasForeignKey("BankId")
                        .HasConstraintName("FK_Vendors_Banks_BankId");
